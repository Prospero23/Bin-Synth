...
export default function NewComment({id}){
    ...
    return(
        <form action="" onSubmit={handleSubmit}>
            ...
            <input type="text" name="author" id="author" value={commentData.author} onChange={handleChange}/>
            <label htmlFor="body">Comment</label>
            <input type="text" name="body" id="body" value={commentData.body} onChange={handleChange}/>
